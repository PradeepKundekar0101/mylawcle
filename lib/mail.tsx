  ...
  return (
    <Layout preview={`Reset your ${settings.APP_NAME} password`}>
      <Section>
        ...
        <Button
          href={link}
          className="w-full text-center my-8 rounded-[54px] bg-[#004376] py-2.5 text-white font-semibold"
        >
          Reset password
        </Button>
  ...
  return (
    <Layout preview={`You have been invite to join ${settings.APP_NAME}`}>
      <Section>
        ...
        <Button
          href={link}
          className="w-full text-center mt-8 rounded-[54px] bg-[#004376] py-2.5 text-white font-semibold"
        >
          Accept invite
        </Button>
      </Section>
    ...
    <Layout preview={`You have reached your ${settings.APP_NAME} page processing limit`}>
      <Section>
        ...
        <Text className="text-[#1D1D1F] text-lg">
          ...
          <a href="mailto:sales@ragie.ai" className="underline text-[#004376]">
            Contact us
          </a>
        </Text>
      </Section>
