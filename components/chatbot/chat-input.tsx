                    ...
                    {props.canSetRerankEnabled && (
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          className="data-[state=checked]:bg-[#004376]"
                        />
                      </div>
                    )}
                      ...
                      <div className="flex flex-col space-y-1">
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="low"
                            id="low"
                            className="text-[#004376] border-[#D7D7D7] data-[state=checked]:bg-[#004376]"
                          />
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                        <div
                          className="bg-[#004376] h-2 rounded-full transition-all duration-500 ease-out"
                          style={{
                            width: `${Math.min(
                      ...
                      <a
                        ...
                        className="w-full text-center text-sm text-[#004376] hover:text-[#C73DE8] py-2 px-4 border border-[#004376] rounded-md hover:bg-[#004376] hover:bg-opacity-5 transition-colors"
                      >
