    ...
    <Form {...form}>
      <div className="flex flex-col gap-6">
        <div>
          ...
          <span className="bg-[#004376] text-white rounded-lg px-3 py-1 text-sm font-semibold ml-2">Early Access</span>
        </div>
    ...
    <div className="w-full p-4 flex-grow flex flex-col relative">
      <div className="flex w-full justify-between items-center mb-12">
        ...
        <div className="flex justify-end">
          ...
          <button
            type="button"
            className="rounded-lg bg-[#004376] text-white disabled:opacity-[55%] px-4 py-2.5 flex items-center"
