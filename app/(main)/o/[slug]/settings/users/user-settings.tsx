                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <textarea
                              ...
                              className="w-full rounded-lg border border-[#004376] bg-[#F5F5F7] px-3 py-2 shadow-none min-h-[80px] max-h-[200px] resize-none overflow-y-auto"
                      ...
                      render={({ field }) => (
                        <FormItem className="mt-4">
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl className="focus:ring-[#004376]">
                              <SelectTrigger>
